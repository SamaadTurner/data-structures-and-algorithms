...
const raisedToTheThird = (arr) => {
  ...
  let resultsArr = [];
  arr.forEach((num) => {
    let raised = Math.pow(num, 3);
    resultsArr.push(raised);
  });
...
const addOne = (arr) => {
  // Solution code here...
  let incrementArray = arr.map((number) => number + 1);
...
const addQuestion = (arr) => {
  // Solution code here...
  let resultingStringArr = arr.map((string) => string + '?');
  return resultingStringArr;
...
const forLoopTwoToThe = (arr) => {
  ...
  for(let i = 0; i < arr.length; i++){
    finalArr.push(Math.pow(2, arr[i]));
  }
  return finalArr;
};
...
const forEachTwoToThe = (arr) => {
  ...
  let finalArr = [];
  arr.forEach((number) => {
    finalArr.push(Math.pow(2, number));
  });
  return finalArr;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  const finalArr = arr.map((number) => Math.pow(2, number));
  return finalArr;
